...
about_text = TagList(
    ...
    tags.ul(tags.li(tags.strong(ui.input_action_link("goto_explore","Explore resources")), ": View individual entries in the database and download a filtered version of the data as .csv file."),
            tags.li(tags.strong(ui.input_action_link("goto_about","About the data explorer")),": This tab provides further information on how to use the Explorer."),        
                    ),
    ))

data_dictionary = TagList(
    tags.div(
        tags.p("Report broken links or any issues to ",tags.a("repindata@iassistdata.org", href="mailto:repindata@iassistdata.org")),
        tags.p("The IASSIST Representation in Data Explorer Data Dictionary is published as a ",tags.a("Google Sheets file", href="https://docs.google.com/spreadsheets/d/1b9ODZxyBzDPfwono_FNJ0N-M3yXlWP8TXbCZXAeVqrQ/edit?usp=sharing", target="_blank"), ", which contains information for understanding the resources and information or metadata about the resources."),
